    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-primary col-md-8" style="padding: 0px;margin-top: 10px; float: right;">
        <div class="panel-heading">
          <h3 class="panel-title">Federal Area</h3>
        </div>
        <div class="panel-body" style="border: 1px solid #337ab7; margin: 5px; border-radius: 5px;">
          <div class="col-md-12" style="margin:0px;padding:0px;">
            <div class="map col-md-12">
                    <!--Google Map-->
                    <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=800&amp;height=300&amp;hl=en&amp;q=Islamabad&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://embedgooglemap.xyz/">embed google map</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:300px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:300px;}.gmap_iframe {height:300px!important;}</style></div>
            </div>
            <div class="col-md-12">
                <hr>
                <div class="col-md-12" style="border-radius: 5px; background-color:#e7e7e7;padding:5px;">
                        <p><b>Islamabad</b> is capital territory of Pakistan. The land of Islamabad was acquired from Punjab and KPK Provinces. The total area that is included in ICT (Islamabad Capital Territory). The ICT areas are controlled, develop and manage by CDA (Capital Development authority). ICTY includes Islamabad Rural Areas, Islamabad Margalla Hills and Islamabad Institutional and Industrial Areas. Islamabad City as a whole has been divided into 5 Zones. The sub division of Islamabad includes Sectors and they are further divided into sub sectors. The total estimated population of Federal Area is 1 million, while the atmosphere and business opportunities of Capital of Pakistan make it one of the suitable and modern areas of Pakistan.</p>       
                </div>
                <div class="col-md-12">
